...
export default function AnalyticsChoiceSlide({
  ...
  return {
    ...
    title: i18n.t(
      "analytics.title",
      "Do you want to help make OnePDF better?",
    ),
    body: (
      <div className={styles.bodyCopyInner}>
        <Trans
          i18nKey="analytics.paragraph1"
          defaults="OnePDF has opt-in analytics to help us improve the product. We do not track any personal information or file contents."
          components={{ strong: <strong /> }}
        />
        <br />
        <Trans
          i18nKey="analytics.paragraph2"
          defaults="Please consider enabling analytics to help OnePDF grow and to allow us to understand our users better."
          components={{ strong: <strong /> }}
        />
        <br />
