                  ...
                  consentModal: {
                    ...
                    description:
                      t(
                        ...
                        "We use cookies and other technologies to make OnePDF work better for you—helping us improve our tools and keep building features you'll love.",
                      ) +
                      "<br>" +
                      t(
                    ...
                    sections: [
                      {
                        ...
                        description:
                          t(
                            ...
                            "OnePDF uses cookies and similar technologies to enhance your experience and understand how our tools are used. This helps us improve performance, develop the features you care about, and provide ongoing support to our users.",
                          ) +
                          "<br><br>" +
                          t(
                            "cookieBanner.preferencesModal.description.2",
                            "OnePDF cannot—and will never—track or access the content of the documents you use.",
                          ) +
                          "<b> " +
                          t(
                      ...
                      },
                      {
                        ...
                        description: t(
                          ...
                          "These cookies help us understand how our tools are being used, so we can focus on building the features our community values most. Rest assured—OnePDF cannot and will never track the content of the documents you work with.",
                        ),
